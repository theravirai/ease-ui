  ...
  return (
    <div className="max-w-4xl mx-auto p-4 space-y-12">
      <div className="space-y-2">
        <h1 className="text-4xl font-bold tracking-tight text-gray-900 dark:text-white">Navbar</h1>
      ...
      <section className="space-y-6">
        ...
        <div className="space-y-3">
          <h3 className="text-lg font-medium text-gray-900 dark:text-white">Light Variant (Default)</h3>
        ...
        <div className="space-y-3">
          <h3 className="text-lg font-medium text-gray-900 dark:text-white">Dark Variant</h3>
